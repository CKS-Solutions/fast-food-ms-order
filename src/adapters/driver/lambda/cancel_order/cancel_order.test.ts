import { handler } from './cancel_order';
...
describe('UpdateOrderStatus HTTP Handler', () => {
  ...
  it('should cancel order successfully', async () => {
    ...
    mockExecute.mockResolvedValue({
      message: 'Order order-123 has been cancelled successfully',
    });
  ...
  it('should return HTTP error response when use case throws HTTPError', async () => {
    ...
    mockExecute.mockRejectedValue(
      new HTTPBadRequest('Order cannot be cancelled'),
    );
