import { handler } from './finish_order';
...
describe('FinishOrder HTTP Handler', () => {
  ...
  it('should finish order successfully', async () => {
    ...
    mockExecute.mockResolvedValue({
      message: 'Order order-123 status updated to Finished successfully',
    });
  ...
  it('should return HTTP error response when use case throws HTTPError', async () => {
    ...
    mockExecute.mockRejectedValue(
      new HTTPBadRequest('Order cannot be finished'),
    );
